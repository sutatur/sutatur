<?php
namespace sutaturism\tests\models\oferta;

use sutaturism\models\oferta\Application_Model_Oferta,
    sutaturism\models\imagine\Application_Model_Imagine;

class Model_SejurTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->model = new Application_Model_Oferta();
  ...
  //  public function testCanReadFromRepository(Application_Model_CategorieOferta $categorieOferta)
   ...
   // }
    ...
    private function _setUpModel()
    {
        ...
        $this->model->adaugaImagine(new Application_Model_Imagine('xx.jpg'));
        $this->model->adaugaImagine(new Application_Model_Imagine('yy.jpg'));
